...
var red = firebase.database().ref(`users/${userid}/ledOne`);
var green = firebase.database().ref(`users/${userid}/ledTwo`);
var ldr = firebase.database().ref(`users/${userid}/ldr`);

//Ultrasonic last 5 value DB reference
var first = firebase.database().ref(`users/${userid}/ultrasonic/valueFirst`);
var second = firebase.database().ref(`users/${userid}/ultrasonic/valueSecond`);
var third = firebase.database().ref(`users/${userid}/ultrasonic/valueThird`);
var fourth = firebase.database().ref(`users/${userid}/ultrasonic/valueFourth`);
var fifth = firebase.database().ref(`users/${userid}/ultrasonic/valueFifth`);
